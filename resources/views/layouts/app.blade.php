            ...
            <div class="container mx-auto flex justify-between items-center">
                <h1 class="text-3xl font-black">
                    ...
                    <nav class="flex gap-2 items-center">
                        ...
                        <a class="font-bold uppercase text-gray-600 text-sm" href="{{ route('posts.index', ['user' => auth()->user()->username]) }}">Perfil</a>
                        <form action="{{ route('logout') }}" method="POST" class="ml-4 flex items-center">
                            @csrf
